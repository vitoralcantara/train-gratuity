...
<head>
	...
	<title>TBP - Confirmar recebimento</title>
	<script>
...
<body>
	<div class="pb-2 mt-4 mb-4 border-bottom title"><label class="lb-lg">Bens a confirmar recebimento</label></div>
		...
		<table class="table table-striped table-bordered table-hover table-sm table-fit text-center align-middle">
			...
			<tbody>
				<tr>
					...
					<td>0000</td>
					<td>CATRACA ELETROMECÂNICA WJ-09 PPCP CINZA-WOLPAC.DISPLAY COMUM</td>
					<td>AG.NATAL</td>
					<td>COOPE</td>
					<td>25/01/2011</td>
					<td>2.400,00</td>
					...
					<td><button class="btn btn-warning">Recusar</button></td>
				</tr>
			</tbody>
		</table>
	</div>
